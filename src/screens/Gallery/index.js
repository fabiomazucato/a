...
import { StatusBar, Image, BackHandler, SafeAreaView, Dimensions, View } from 'react-native';
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <Container background={theme.colors.primary}>
        ...
        <EventContainer>
          ...
          <EventDetails>
            <EventMainDetails>
              <EventMainDetailsTitle color={theme.colors.header}>
                {event && event.name}
              </EventMainDetailsTitle>
              <EventMainDetailsRow>
                ...
                <EventMainDetailsRowData color={theme.colors.header}>
            ...
            <EventCapacityContainer>
              <EventCapacityQuantity color={theme.colors.header}>
                {event && event.capacity}
              </EventCapacityQuantity>
              <EventCapacityText color={theme.colors.header}>
                Photoguesters
              </EventCapacityText>
            </EventCapacityContainer>
          </EventDetails>
...
Gallery.navigationOptions = ({ tintColor, navigationOptions }) => ({
  ...
  tabBarIcon: ({ focused, horizontal, tintColor }) => (
   <View style={{marginTop: 16}}>
      <Image source={require ('../../assets/images/galeria.png')} style={{width: 40, height:26}}/>
   </View>
  ),
});
